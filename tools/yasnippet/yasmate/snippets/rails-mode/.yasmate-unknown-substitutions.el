...
;; 
;; # as in Snippets/validates_exclusion_of (ve).yasnippet
;;                                                                                            =yyas> (yas-unknown)
;; 
;; # as in Snippets/licai.yasnippet
;; text.html.erb.rails, text.haml                                                             =yyas> (yas-unknown)
;; 
;; # as in Snippets/belongs_to (bt).yasnippet
;; meta.rails.model                                                                           =yyas> (yas-unknown)
;; 
;; # as in Snippets/content_for.yasnippet
;; text.html.erb.rails                                                                        =yyas> (yas-unknown)
;; 
